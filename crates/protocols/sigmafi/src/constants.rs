...
pub const DEV_FEE_NUM: u64 = 500; // 0.5%
pub const UI_FEE_NUM: u64 = 400; // 0.4%
pub const FEE_DENOM: u64 = 100_000;

pub const SAFE_MIN_BOX_VALUE: i64 = 1_000_000; // 0.001 ERG
pub const STORAGE_PERIOD: i32 = 1_051_200; // ~4 years in blocks
