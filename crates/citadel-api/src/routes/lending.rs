...
async fn build_refund(
    ...
    let r4_as_tree = r4_encoded.and_then(|r4| decode_sigma_byte_array(r4).ok());
    let is_repay_proxy = r4_as_tree.is_none();
    let user_ergo_tree = r4_as_tree
